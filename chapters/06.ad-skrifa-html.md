...
Þessi forrit nýta [_static analysis_](https://en.wikipedia.org/wiki/Static_program_analysis) á forritskóðanum okkur (hvort sem það er HTML, CSS, eða eitthvað annað forritunarmál). Forritn eru ekki keyrð, heldur eru þau þáttuð og borin saman við reglur forritunarmálsins og hugsanlega sérsniðnar reglur sem teymi hefur sett sér.
...
Ýkt dæmi með blönduðum bilum og tabs. Athuguð að birting hér þýðir tab yfir í fjögur bil.
