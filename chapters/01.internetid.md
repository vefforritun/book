...
* Hugsanlega tvípunkti og port-númeri, ef ekki er sjálfefna port samskiptareglu notað (`80` fyrir `http` , `443` fyrir `https`)
* Slóð á vefsíðu
